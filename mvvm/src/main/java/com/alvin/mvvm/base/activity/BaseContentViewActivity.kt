 ...
 * @author Alvin
 */
abstract class BaseContentViewActivity : BaseDialogActivity() {
    /**
     * 获取左侧Icon View
     */
    ...
    private fun loadTitleView() {
        ...
        // 默认的属性回调
        iSettingActivity.setTitleLayoutView(
            this,
            ibBarBack,
            tvBarTitle,
            tvBarRight,
    ...
    open fun <T : ViewDataBinding?> putTitleView(
        ...
        return iSettingActivity.putTitleView(inflater, parent)
    }
    ...
    open fun <T : ViewDataBinding?> putLoadingView(
        ...
        return iSettingActivity.putLoadingView(inflater, parent)
    }
    ...
    open fun <T : ViewDataBinding?> putNoNetView(
        ...
        return iSettingActivity.putNoNetView(inflater, parent)
    }
     ...
     * @return 是否需要内边距
     */
    open fun isStatusPadding(): Boolean = iSettingActivity.isStatusPadding()
     ...
     */
    @IdRes
    open fun noNetClickId(): Int = iSettingActivity.noNetClickId()
     ...
     */
    @DrawableRes
    open fun titleLeftIcon(): Int = iSettingActivity.titleLeftIcon()
     ...
     * @return Boolean
     */
    open fun isShowNoNetLayout(): Boolean = iSettingActivity.isShowNoNetLayout()
